...
number_spans1.addEventListener("click", () => {
  ...
  number_spans1.classList.add("fontsize");
  number_spans2.classList.remove("fontsize");
  number_spans3.classList.remove("fontsize");
  number_spans4.classList.remove("fontsize");
  number_spans5.classList.remove("fontsize");
  number_spans6.classList.remove("fontsize");
});
...
number_spans2.addEventListener("click", () => {
  ...
  number_spans1.classList.remove("fontsize");
  number_spans2.classList.add("fontsize");
  number_spans3.classList.remove("fontsize");
  number_spans4.classList.remove("fontsize");
  number_spans5.classList.remove("fontsize");
  number_spans6.classList.remove("fontsize");
...
number_spans3.addEventListener("click", () => {
  ...
  number_spans1.classList.remove("fontsize");
  number_spans2.classList.remove("fontsize");
  number_spans3.classList.add("fontsize");
  number_spans4.classList.remove("fontsize");
  number_spans5.classList.remove("fontsize");
  number_spans6.classList.remove("fontsize");
});
number_spans4.addEventListener("click", () => {
  ...
  number_spans2.classList.remove("fontsize");
  number_spans3.classList.remove("fontsize");
  number_spans4.classList.add("fontsize");
  number_spans5.classList.remove("fontsize");
  number_spans6.classList.remove("fontsize");
});
...
number_spans5.addEventListener("click", () => {
  ...
  number_spans3.classList.remove("fontsize");
  number_spans4.classList.remove("fontsize");
  number_spans5.classList.add("fontsize");
  number_spans6.classList.remove("fontsize");
});
...
number_spans6.addEventListener("click", () => {
  ...
  number_spans4.classList.remove("fontsize");
  number_spans5.classList.remove("fontsize");
  number_spans6.classList.add("fontsize");
});
